...
export function BaccaratTableClient({ tableId, userId, nickname, initialBalance }: BaccaratTableClientProps) {
    ...
    if (!isMounted) {
        return (
            <div className="w-full flex-1 min-h-[calc(100dvh-80px)] md:min-h-0 md:h-[calc(100vh-120px)] bg-slate-50 dark:bg-[#1a1c20] rounded-xl flex items-center justify-center border border-slate-200 dark:border-white/10 shadow-2xl transition-colors">
    ...
    return (
        <div className="w-full flex-1 min-h-[calc(100dvh-80px)] md:min-h-0 md:h-[calc(100vh-120px)] bg-slate-50 dark:bg-[#1a1c20] rounded-xl flex flex-col overflow-hidden select-none relative font-sans text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 shadow-2xl transition-colors">
            ...
            <div className="absolute inset-0 opacity-100 pointer-events-none bg-[linear-gradient(rgba(0,0,0,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.05)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)]" style={{ backgroundSize: '40px 40px' }} />
