    ...
    return (
        <div className="w-full lg:w-[380px] bg-black/80 border-t lg:border-t-0 lg:border-l border-white/10 p-2 md:p-4 shrink-0 flex flex-row lg:flex-col gap-2 md:gap-4 overflow-x-auto lg:overflow-x-visible h-[120px] lg:h-auto scrollbar-hide backdrop-blur-md transition-colors z-20">
            <div className="flex items-center gap-2 text-white/70 px-1 shrink-0 lg:shrink">
                ...
                <span className="text-[10px] md:text-sm font-bold uppercase tracking-widest text-white/90">Roadmap</span>
            </div>

            {/* Bead Plate */}
            <div className="flex-1 bg-white/5 border border-white/10 rounded-lg p-1.5 min-w-[300px] lg:min-w-0 flex flex-col gap-1 overflow-hidden transition-colors shadow-inner">
                <div className="grid grid-rows-6 grid-flow-col gap-1 h-full w-max lg:w-full overflow-x-auto scrollbar-hide py-1">
                    <AnimatePresence>
