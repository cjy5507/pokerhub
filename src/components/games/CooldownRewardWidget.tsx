...
export function CooldownRewardWidget() {
  ...
  return (
    <div className="relative w-full bg-[#1e1e1e] border border-[#333] rounded-lg p-4 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#c9a227]/5 via-transparent to-transparent pointer-events-none" />

      {/* Celebration overlay */}
      {showCelebration && (
        <div className="absolute inset-0 bg-gradient-to-t from-[#c9a227]/20 via-[#c9a227]/10 to-transparent animate-pulse pointer-events-none z-10 flex items-center justify-center">
          <div className="flex flex-col items-center gap-2">
            <Sparkles className="w-12 h-12 text-[#c9a227] animate-bounce" />
            <span className="text-2xl font-bold text-[#c9a227] drop-shadow-lg">
              +{stats.lastReward}P
            </span>
          </div>
        </div>
      ...
      <div className="relative flex items-center gap-2 mb-4">
        ...
        <h3 className="text-[#c9a227] font-bold text-lg">포인트 수확</h3>
      </div>

      {/* Divider */}
      <div className="h-px bg-gradient-to-r from-transparent via-[#c9a227]/30 to-transparent mb-4" />
      ...
      <button
        ...
        className={cn(
          ...
          isAvailable
            ? 'bg-gradient-to-br from-[#c9a227] to-[#a88620] border-[#d4b02f] text-[#1e1e1e] hover:shadow-lg hover:shadow-[#c9a227]/50 hover:scale-105 animate-pulse'
            : 'bg-[#2a2a2a] border-[#3a3a3a] text-[#888] cursor-not-allowed grayscale'
        )}
      >
      ...
      <div className="mt-4 space-y-2 text-sm">
        {stats.lastReward > 0 && (
          <div className="flex items-center justify-between text-[#888]">
            ...
            <span className="text-[#c9a227] font-bold">+{stats.lastReward}P</span>
          </div>
        )}
      ...
      {stats.harvestCount > 0 && (
        <div className="mt-3">
          <div className="h-1 bg-[#2a2a2a] rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#c9a227] to-[#d4b02f] transition-all duration-500"
