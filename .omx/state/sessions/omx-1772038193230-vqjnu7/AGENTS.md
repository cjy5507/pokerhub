...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1772038193230-vqjnu7 | 2026-02-25T16:49:53.252Z

**Codebase Map:**
  src/: instrumentation, middleware
  src/__tests__/: actions.test, password.test, session.test, actions.test, actions.test, actions.test, mocks, actions.test, actions.test, actions.test
  src/app/: actions.test, actions, layout, page, page, page, page, page, page, actions
  src/components/: PostRow, ChatProvider, ChatSidebarPanel, MobileChatDrawer, EditorToolbar, ImageUploadButton, RichTextEditor, CooldownRewardWidget, AttendanceCalendar
  src/hooks/: useAuth
  src/lib/: password, session, broadcast, constants, relations, schema, seed, design-tokens, attendance.test
  src/types/: poker
  scripts/: seed-content
  (root): drizzle.config, eslint.config, next.config, postcss.config, seed, sentry.client.config, sentry.edge.config, sentry.server.config, test-baccarat, vitest.config
