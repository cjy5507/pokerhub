        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          {unreadCount > 0 && (
            <button
              ...
              disabled={isPending}
              className="px-4 py-2 bg-[#1e1e1e] border border-[#333] rounded-lg text-[#c9a227] hover:bg-[#252525] transition-colors text-sm disabled:opacity-50"
            >
          ...
          <div className="space-y-2">
            {notifications.map((notification) => (
              <div
                ...
                className={`bg-[#1e1e1e] border border-[#333] rounded-lg p-4 transition-all hover:bg-[#252525] cursor-pointer ${
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-md text-[#666] hover:text-red-400 hover:bg-[#333] transition-colors"
                          aria-label="삭제"
                        >
        ...
        {hasMore && (
          <div className="mt-6 text-center">
            <button
              ...
              className="px-6 py-2 bg-[#1e1e1e] border border-[#333] rounded-lg text-[#c9a227] hover:bg-[#252525] transition-colors disabled:opacity-50"
            >
