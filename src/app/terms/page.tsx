  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-[#1a1a1a] rounded-lg p-6 space-y-6 text-[#a0a0a0] text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제3조 (약관의 효력 및 변경)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제4조 (회원가입 및 계정)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제5조 (서비스의 제공 및 변경)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제6조 (포인트)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제7조 (이용자의 의무)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제8조 (게시물의 관리)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제9조 (서비스 이용 제한)</h2>
          <p>회사는 이용자가 제7조의 의무를 위반하거나 서비스의 정상적인 운영을 방해한 경우, 경고·일시정지·영구이용정지 등의 단계로 서비스 이용을 제한할 수 있습니다.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제10조 (면책조항)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#e0e0e0] mb-3">제11조 (분쟁 해결)</h2>
