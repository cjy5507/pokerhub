export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-ph-text mb-6">이용약관</h1>
      <div className="bg-ph-surface rounded-lg p-6 space-y-6 text-ph-text-secondary text-sm leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제1조 (목적)</h2>
          <p>이 약관은 PokerHub(이하 &quot;회사&quot;)가 제공하는 온라인 포커 커뮤니티 서비스(이하 &quot;서비스&quot;)의 이용조건 및 절차, 회사와 이용자 간의 권리·의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제2조 (정의)</h2>
          <p>1. &quot;서비스&quot;란 회사가 운영하는 PokerHub 포커 커뮤니티 플랫폼 및 관련 제반 서비스를 말합니다.</p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제3조 (약관의 효력 및 변경)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제4조 (회원가입 및 계정)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제5조 (서비스의 제공 및 변경)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제6조 (포인트)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제7조 (이용자의 의무)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제8조 (게시물의 관리)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제9조 (서비스 이용 제한)</h2>
          <p>회사는 이용자가 제7조의 의무를 위반하거나 서비스의 정상적인 운영을 방해한 경우, 경고·일시정지·영구이용정지 등의 단계로 서비스 이용을 제한할 수 있습니다.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제10조 (면책조항)</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-ph-text mb-3">제11조 (분쟁 해결)</h2>
          <p>1. 회사와 이용자 간에 발생한 분쟁에 대해 이용자는 회사에 이의를 제기할 수 있습니다.</p>
          <p>2. 본 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 대한민국 관계 법령에 따릅니다.</p>
        </section>

        <p className="text-ph-text-muted pt-4 border-t border-ph-border">시행일: 2026년 2월 18일</p>
      </div>
    </div>
  );
}
